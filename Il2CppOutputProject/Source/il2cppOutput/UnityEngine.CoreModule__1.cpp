...
{
	int32_t V_0 = 0;
	TouchScreenKeyboard_tE87B78A3DAED69816B44C99270A734682E093E7A* V_1 = NULL;
	{
		V_0 = 0;
		String_t* L_0 = ___0_text;
		int32_t L_1 = ___1_keyboardType;
...
IL_0016:
	{
		TouchScreenKeyboard_tE87B78A3DAED69816B44C99270A734682E093E7A* L_9 = V_1;
		return L_9;
	}
}
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool APIUpdaterRuntimeHelpers_GetMovedFromAttributeDataForType_m572E9998D4C574A15D5D044699A572DEBC3FC1E3 (Type_t* ___0_sourceType, String_t** ___1_assembly, String_t** ___2_nsp, String_t** ___3_klass, const RuntimeMethod* method) 
{
	...
	bool V_3 = false;
	{
		...
		*((RuntimeObject**)L_2) = (RuntimeObject*)NULL;
		...
		L_6 = VirtualFuncInvoker2< ObjectU5BU5D_t8061030B0A12A55D5AD8652A20C922FE99450918*, Type_t*, bool >::Invoke(14, L_3, L_5, (bool)0);
		V_0 = L_6;
...
IL_00fd:
	{
		...
		NullCheck(L_47);
		Assembly_t* L_48;
		L_48 = VirtualFuncInvoker0< Assembly_t* >::Invoke(27, L_47);
		NullCheck(L_48);
...
IL_003b:
	{
		...
		NullCheck(L_14);
		Type_t* L_18;
		L_18 = VirtualFuncInvoker1< Type_t*, TypeU5BU5D_t97234E1129B564EB38B8D85CAC2AD8B5B9522FFB* >::Invoke(121, L_14, L_16);
		V_2 = L_18;
		Type_t* L_19 = V_2;
